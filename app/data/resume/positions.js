...
const positions = [
  ...
  {
    company: 'Ningbo Institute of Industrial Technology, Chinese Academy of Sciences',
    position: 'Visiting Professor',
    link: 'http://english.nimte.cas.cn/',
    daterange: 'January 2018 - May 2015',
    points: [
      'Successfully commanded some group theoretical methods and shared the skill within the work group.',
      'Constructed an effective model for a system with topological nodal ring using the new approach.',
...

  {
    ...
    points: [
      'Explore the application potential of topological materials in the direction of spintronics.',
      'Proved some novel symmetry relation of spin transport within a theoretical model of a Weyl semimetal.',
    ],
  },

  {
    ...
    company: 'University of johns hopkins',
    position: 'Visiting Scholar',
    ...
    company: 'ZheJiang Normal University',
    position: 'Professor',
    link: 'http://www.zjnu.edu.cn/english/',
